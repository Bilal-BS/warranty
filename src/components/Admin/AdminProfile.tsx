...
import { User, Mail, Phone, Building, Key, Lock, Save, X } from 'lucide-react';
...
export const AdminProfile: React.FC<AdminProfileProps> = ({ admin, onClose, onUpdate }) => {
  ...
  const handleSecurityUpdate = async (e: React.FormEvent) => {
    ...
    if (securityData.currentPassword !== admin.password) {
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => setSecurityData(prev => ({ ...prev, newPin: e.target.value.replace(/\D/g, '').slice(0, 4) }))}
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      onChange={(e) => setSecurityData(prev => ({ ...prev, confirmPin: e.target.value.replace(/\D/g, '').slice(0, 4) }))}
                      className="w-full pl-10 pr-4 py-3 border border-gray-300 rounded-xl text-center font-mono tracking-widest focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                      placeholder="••••"
                      maxLength={4}
                      disabled={isLoading}
